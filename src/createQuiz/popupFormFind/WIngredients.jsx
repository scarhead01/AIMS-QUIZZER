...
const RecipeForm = ({ setOpenModal2, game, cat,subCat, setNums }) => {
 ...
 // const setNum = setNums
  ...
  console.log(iName+imgUrl+imgCc+imgUrlCc)
  console.log()
    ...
    setimgUrlCc(data.imgUrlCc)
      ...
      const [addIngredients,{loading}] = useMutation(ADD_WINGREDIENTS,{
        variables:{gameId,cats,scName,setNum,rName,iName,imgUrl,imgCc,imgUrlCc},
          refetchQueries: [{ query: FETCH_RECIPE_QUERY, variables:{cats,scName,setNum} }]
      })
  ...
  return (
   ...
   <TitleCloseBtn
      ...
      <Form>
      <Heading> <h1>Add New Wrong Ingredients</h1> </Heading>
...
const ADD_WINGREDIENTS = gql`
mutation($gameId: ID!, $cats: String!, $scName: String!, $setNum: String!, $rName: String!, $iName: String!, $imgUrl: String!, $imgCc: String!, $imgUrlCc: String!) {
  insertwIngredient(gameId: $gameId, cName: $cats, scName: $scName, setNum: $setNum, rName: $rName, iName: $iName, imgUrl: $imgUrl, imgCc: $imgCc, imgUrlCc: $imgUrlCc) {
    id
