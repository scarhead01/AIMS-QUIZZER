...
const RecipeForm = ({ setOpenModal, game, cat,subCat, setNums }) => {
  ...
  console.log()
    ...
    const onSubmit = (data) => {
      ...
      const [addRecipe,{loading}] = useMutation(ADD_RECIPE,{
        variables:{gameId,cName,scName,setNum,rName,rImgUrl,imgCc,rCc,rUrl},
          refetchQueries: [{ query: FETCH_RECIPE_QUERY, variables:{cName,scName,setNum} }]
      })
...
/>
<label>Recipe Author/Source</label>
<input
  {...register("rCc", { minLength: 2 })}
  placeholder="recipe author/source"
/>
 <label>Image Copyright Url</label>
<input
  {...register("rUrl", { minLength: 2 })}
...
mutation InsertRecipe($gameId: ID!, $cName: String!, $scName: String!, $setNum: String!, $rName: String!, $rImgUrl: String!, $imgCc: String!, $rCc: String!, $rUrl: String!) {
  insertRecipe(gameId: $gameId, cName: $cName, scName: $scName, setNum: $setNum, rName: $rName, rImgUrl: $rImgUrl, imgCc: $imgCc, rCc: $rCc, rUrl: $rUrl) {
    id
    rName
  }
}
...
query ( $cName: String!, $scName: String!, $setNum: String!) {
  getRecipes(gameId: "6227003f9ac1104969591b20", cName: $cName, scName: $scName, setNum: $setNum) {
