...
const Question = ({ setOpenModal, game, cat }) => {

  //const [gameId, setgameId] = useState('')
  const [cats, setcats] = useState('')
 // const [cName, setscName] = useState('')
  const [question, setquestion] = useState('')
  const [cAnswer, setCAns] = useState('')
...
const cName= cat;
  ...
  console.log(cat)
    ...
    const [AddSub,{loading}] = useMutation(ADD_SUBCAT,{
        ...
        variables:{gameId,cName,question,cAnswer},
        refetchQueries: [{ query: FETCH_CATEGORY_QUERY, variables:{gameId}}]
    })
  ...
  return (
   ...
   <TitleCloseBtn
      ...
      />
       <input
        {...register("cAnswer", { required: true })}
...
mutation InsertCategoryQuest($gameId: ID!, $cName: String!, $question: String!, $cAnswer: String!) {
  insertCategoryQuest(gameId: $gameId, cName: $cName, question: $question, cAnswer: $cAnswer) {
    id
    cName
    quizQuestions {
      question
