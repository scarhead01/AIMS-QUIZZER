...
const CatForm = ({ setOpenModal, game, cat }) => {
...
const ADD_SUBCAT = gql `
 mutation InsertCategoryQuiz($gameId: ID!,$cName:String!) {
  insertCategoryQuiz(gameId: $gameId,cName:$cName) {
    id
  }
}
