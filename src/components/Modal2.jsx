...
function Modal2({ setOpenModal2 }) {
  ...
  navigate(`/game/guess/guessmenu/${diffi}/${cate}`);
    ...
    <ModalBackground     
      ...
      <ModalContainer>
       ...
       <ModalBody>
           ...
           <BodyButton2 className={cat==="Equipment" ? "active":""} onClick={Category.bind(this,"Equipment")} onMouseOver={ImgHover.bind(this,"Beverages")} onMouseLeave={ImgnoHover.bind(this,"Beverages")} >
